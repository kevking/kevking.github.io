$(document).ready(function(){
	...
	var info = ["鱼粉店","火凤凰","刘聋子","牛肉粉","老刘炒码粉","老粉铺","清香粉铺","鑫城卤粉","攸县烧汤粉","自己做"];
	var info1 = ['','','','','','','','','','']
	canvasRun();
	...
	function probability(){
		//获取随机数
		var num = parseInt(Math.random()*(9 - 0 + 0) + 0);
		//概率
		if ( num == 0 ) {
	...
	function canvasRun(){
		...
		function initPoint(){ 
	        ...
	        //中间小圆
	        ctx3.beginPath();
	        ctx3.arc(100,100,50,0,Math.PI*2,false);
